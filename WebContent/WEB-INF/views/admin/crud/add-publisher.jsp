...
<link type='text/css' rel="stylesheet"
	href="assets/styles/admin/add-publisher.css" />
<body>
	<div class="wrapper">
		...
		<div class="container">
			<form action="add-publisher.htm" method="post" class="form-control">
				<h1 class="title">ADD NEW PUBLISHER</h1>
				...
				<div class="cover-btn">
					<input class="btn-submit" type="submit" value="ADD PUBLISHER" />
				</div>
			</form>
		</div>
	</div>
