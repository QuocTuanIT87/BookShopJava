...
<link type='text/css' rel="stylesheet"
	href="assets/styles/admin/update-category.css" />
</head>
<body>
	<div class="wrapper">
		...
		<div class="container">
			<form action="add-category.htm?type=edit&id=${cate.idCategory }" method="post"
				...
				<div class="content">
					<div class="field">
						<label class="form-label"><b>Category name</b></label> <input
							...
							placeholder="Category name" name="category" value="${cate.categoryName }"/>
					</div>
				...
				<div class="choose-file">
					<img id="blah" alt="your image" class="book-image" src="${cate.image }"/>
				</div>
				<div class="cover-btn">
